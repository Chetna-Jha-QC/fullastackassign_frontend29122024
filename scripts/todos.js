document.getElementById('add-todo-form').addEventListener('submit', async (e) => {
    ...
    await fetch('https://steadfast-lily-toy.glitch.me/todos', {
        method: 'POST',
...
async function loadTodos() {
    const response = await fetch('https://steadfast-lily-toy.glitch.me/todos');
...
async function deleteTodo(id) {
    await fetch(`https://steadfast-lily-toy.glitch.me/todos/${id}`, { method: 'DELETE' });
    alert('Todo deleted.');
    loadTodos();
}
